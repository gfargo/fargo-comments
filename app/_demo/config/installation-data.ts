...
export const installationConfig: InstallationConfig = {
  ...
  coreCommands: [
    {
      name: "Core System",
      command: "npx shadcn@latest add https://commentsby.okayd.com/r/core",
      description: "Essential commenting system with contexts, hooks, types, and Lexical editor",
      required: true
    },
    {
      name: "Comment List",
      command: "npx shadcn@latest add https://commentsby.okayd.com/r/comment-list",
      description: "Main comment listing component with search functionality",
      required: false
    },
    {
      name: "Comment Drawer",
      command: "npx shadcn@latest add https://commentsby.okayd.com/r/drawer",
      description: "Sidebar/drawer component for centralized comment management",
      required: false
    },
    {
      name: "Server Actions Adapter",
      command: "npx shadcn@latest add https://commentsby.okayd.com/r/adapter-server-actions",
  ...
  additionalAdapters: [
    {
      name: "API Adapter",
      command: "npx shadcn@latest add https://commentsby.okayd.com/r/adapter-api",
      description: "REST API integration for external services",
      required: false
    },
    {
      name: "TanStack Query Adapter",
      command: "npx shadcn@latest add https://commentsby.okayd.com/r/adapter-tanstack-query",
