...
export const installationConfig: InstallationConfig = {
  ...
  registryUrl: "https://comments.griffen.codes/api/registry",
  prerequisiteCommand: "npx shadcn@latest init",
  
  coreCommands: [
    {
      name: "Core System",
      command: "npx shadcn@latest add https://comments.griffen.codes/api/registry/r/core",
      description: "Essential commenting system with contexts, hooks, types, and Lexical editor",
      required: true
    },
    {
      name: "Comment List",
      command: "npx shadcn@latest add https://comments.griffen.codes/api/registry/r/comment-list",
      description: "Main comment listing component with search functionality",
      required: false
    },
    {
      name: "Comment Drawer",
      command: "npx shadcn@latest add https://comments.griffen.codes/api/registry/r/drawer",
      description: "Sidebar/drawer component for centralized comment management",
      required: false
    },
    {
      name: "Server Actions Adapter",
      command: "npx shadcn@latest add https://comments.griffen.codes/api/registry/r/adapter-server-actions",
  ...
  additionalAdapters: [
    {
      name: "API Adapter",
      command: "npx shadcn@latest add https://comments.griffen.codes/api/registry/r/adapter-api",
      description: "REST API integration for external services",
      required: false
    },
    {
      name: "TanStack Query Adapter",
      command: "npx shadcn@latest add https://comments.griffen.codes/api/registry/r/adapter-tanstack-query",
