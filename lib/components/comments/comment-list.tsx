...
import { CommentSearch } from "@/lib/components/comments/comment-search"
...
import { useComments } from "@/lib/contexts/comment-context"; // Fixed import path to use correct location
